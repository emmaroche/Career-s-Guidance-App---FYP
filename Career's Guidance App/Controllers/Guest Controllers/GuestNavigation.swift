...
class GuestNavigation: UITabBarController {

    override func viewDidLoad() {
        super.viewDidLoad()
        
//        let homeVC = HomeController()
        let quizScreen = UIHostingController(rootView: GuestQuizWelcomeScreen())
//        let resultsDashboard = UIHostingController(rootView: GuestResultsDashboard())
...
//        self.setViewControllers([homeVC, quizScreen, resultsDashboard, account], animated: false)
        ...
        self.setViewControllers([quizScreen, account], animated: false)
...
//        let images = ["house.fill", "lightbulb.fill", "chart.bar.xaxis", "person.fill"]
        let images = ["lightbulb.fill", "person.fill"]
